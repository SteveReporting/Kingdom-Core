...
// Highest prestige first. Permission names are mapped to Discord flags at runtime.
export const ROLE_BLUEPRINT = [
  { key: 'crown', name: '👑 The Crown', color: 0xf1c40f, hoist: true, permissions: [] },
  { key: 'regent', name: '♛ Regent', color: 0xe5b80b, hoist: true, permissions: ['ManageGuild', 'ManageRoles', 'ManageChannels', 'ManageMessages', 'ModerateMembers', 'KickMembers', 'BanMembers'] },
  { key: 'council', name: '⚜️ Royal Council', color: 0xc9a227, hoist: true, permissions: ['ManageChannels', 'ManageMessages', 'ModerateMembers', 'KickMembers'] },
  { key: 'lordCommander', name: '⚔️ Lord Commander', color: 0xb7950b, hoist: true, permissions: ['ManageMessages', 'ModerateMembers'] },
  { key: 'chancellor', name: '📜 Chancellor', color: 0xb7950b, hoist: true, permissions: ['ManageMessages'] },
  { key: 'steward', name: '🗝️ Steward', color: 0xa88616, hoist: true, permissions: ['ManageMessages'] },

  { key: 'royalGuard', name: '🛡️ Royal Guard', color: 0x992d22, hoist: true, permissions: ['ManageMessages', 'ModerateMembers', 'KickMembers'] },
  { key: 'castleGuard', name: '🏰 Castle Guard', color: 0xc27c0e, hoist: true, permissions: ['ManageMessages', 'ModerateMembers'] },
  { key: 'watchman', name: '🔭 Watchman', color: 0xe67e22, hoist: true, permissions: ['ManageMessages'] },
  { key: 'scribe', name: '✒️ Royal Scribe', color: 0x9b59b6, hoist: true, permissions: ['ManageMessages'] },
  { key: 'herald', name: '📯 Herald', color: 0x3498db, hoist: true, permissions: ['ManageMessages'] },
  { key: 'courtMage', name: '🔮 Court Mage', color: 0x71368a, hoist: true, permissions: [] },

  { key: 'royalChampion', name: '🏆 Royal Champion', color: 0xf1c40f, hoist: true, permissions: [] },
  { key: 'knightCaptain', name: '🗡️ Knight Captain', color: 0x95a5a6, hoist: true, permissions: [] },
...
export const CHANNEL_BLUEPRINT = [
  ...
  { key: 'houses', category: 'progression', name: '🏰・house-hall', type: 'text' },
...
export const STAFF_KEYS = ['crown', 'regent', 'council', 'lordCommander', 'chancellor', 'steward', 'royalGuard', 'castleGuard', 'watchman', 'scribe', 'herald', 'courtMage'];
