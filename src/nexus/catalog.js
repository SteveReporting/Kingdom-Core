...
export const NEXUS_PRODUCTS = Object.freeze([
  ...
  { id: 7, slug: 'identity', name: 'Kingdom Identity', type: 'identity-platform', summary: 'Canonical member identity joining Discord and Roblox-facing profile data.', capabilities: ['Discord OAuth session', 'canonical profile', 'Roblox identity field', 'rename-safe history'] },
  ...
  { id: 11, slug: 'tv', name: 'Kingdom TV', type: 'broadcast-ui', summary: 'OBS/browser-source friendly live display for streams and events.', capabilities: ['TV route', 'SSE live refresh', 'large-format layout', 'stream overlay ready'] },
  ...
  { id: 13, slug: 'api', name: 'Kingdom API', type: 'developer-api', summary: 'Documented HTTP API exposing safe Kingdom data and controlled actions.', capabilities: ['versioned endpoints', 'Discord/session or token writes', 'public-safe reads', 'live stream endpoint'] },
  { id: 14, slug: 'sdk', name: 'Kingdom SDK', type: 'developer-sdk', summary: 'Zero-dependency JavaScript client for the Kingdom API.', capabilities: ['JS client', 'live stream client', 'browser/node compatible', 'no external package required'] },
  ...
  { id: 20, slug: 'nexus', name: 'Kingdom Nexus', type: 'unified-control-plane', summary: 'One control plane joining every Kingdom product into a single ecosystem.', capabilities: ['single navigation', 'Discord identity', 'shared API', 'shared state', 'shared security'] }
]);
