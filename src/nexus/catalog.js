...
export const NEXUS_PRODUCTS = Object.freeze([
  ...
  { id: 3, slug: 'mobile', name: 'Kingdom Mobile', type: 'pwa', summary: 'Installable mobile experience for carries, events, profiles and guild operations.', capabilities: ['PWA install', 'mobile-first UI', 'privacy-safe offline shell', 'standalone app mode', 'touch-friendly operations'] },
  ...
  { id: 17, slug: 'vault', name: 'Kingdom Vault', type: 'backup-platform', summary: 'State snapshots and disaster recovery with retention, SHA-256 verification, safety backups and explicit restore.', capabilities: ['on-demand backup', 'automatic backup', 'SHA-256 verification', 'retention', 'verified restore'] },
  ...
  { id: 19, slug: 'ai', name: 'Kingdom AI', type: 'ai-gateway', summary: 'Private read-only AI operations assistant with a Cloudflare Workers AI edge runtime and optional local-provider fallback.', capabilities: ['Workers AI edge inference', 'optional local endpoint fallback', 'sanitized aggregate context', 'dedicated rate limit', 'operator-only execution'] },
...
export const FREE_RUNTIME_POLICY = Object.freeze({
  ...
  defaultHosting: 'existing Oracle VM + Cloudflare Workers Free plan',
  mobileDistribution: 'installable PWA',
  desktopDistribution: 'installable PWA',
  ai: 'Cloudflare Workers AI free allocation through Kingdom Nexus; optional local provider fallback',
